...
\begin{tabularx}{1\linewidth}{X}
	...
	$\star$ Deep knowledge and constantly learning about agile culture and some agile methods like Scrum, Lean, Kanban, XP and TDD.\vspc\\
	
	$\star$ Active participant in the community through technology events as a speaker and listener, online discussion groups and personal blog post. \vspc\\
\end{tabularx}
...
\section{Volunteers}
\begin{tabularx}{1\linewidth}{X}
{\bf GDG-SP Android Meetup Leader \hfill Apr/2013 - Current} \\
The Android Meetup is a meeting focused on developing with the Android platform. This meeting is hosted by the group GDG-SP (Google Developers Group - São Paulo), which voluntarily organizes several meetings about Google technologies. I joined the group in April 2013 and since then I help organize the Android Meetup. \vspc\\
\end{tabularx}
