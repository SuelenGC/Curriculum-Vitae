...
\begin{center}
\textsc{\Huge{Suelen Goularte Carvalho - 27 anos}} \vspc\\
...
\begin{tabularx}{1\linewidth}{X}
	$\star$ Grande experiência com arquitetura de software web e mobile com mais de 9 anos com programação e liderança. Muito entusiasmada por software e novas tecnologias. \vspc\\
...
Líder de times de desenvolvimento de software, colaborando na construção da cultura e processos destes times, gestão de pessoas, responsável pela contratação de talentos de tecnologia e também desenvolvedora. \vspc\\
\end{tabularx}

\begin{tabularx}{1\linewidth}{X}
{\bf Caelum Ensino e Inovação $\star$ Desenvolvedor e Instrutor \hfill Nov/2014 $-$ Ago/2014} \\
...
\begin{tabularx}{1\linewidth}{X}
{\bf MapLink $\star$ Arquiteto de Software \hfill Ago/2012 $-$ Nov/2013} \\
