...
\begin{document}
\name{Suelen Goularte Carvalho}
\tagline{Strategic Tech Woman \& Proud Geek}
% Cropped to square from https://en.wikipedia.org/wiki/Marissa_Mayer#/media/File:Marissa_Mayer_May_2014_(cropped).jpg, CC-BY 2.0
% \photo{2.5cm}{mmayer-wikipedia-cc-by-2_0}
\personalinfo{%
  % Not all of these are required!
  % You can add your own with \printinfo{symbol}{detail}
  \email{suelengcarvalho@gmail.com}
  \phone{(11) 95020-0060}
%   \mailaddress{Address, Street, 00000 County}
  \location{São Paulo, SP}
  \homepage{http://suelengc.com}
  \twitter{@suelengc}
  \linkedin{linkedin.com/in/suelengc}
  \github{github.com/suelengc} % I'm just making this up though.
...
\cvevent{President \& CEO}{Yahoo!}{September 2016 -- Ongoing}{São Paulo, BR}
\begin{itemize}
